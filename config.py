...
OWNER_USERNAME = getenv("OWNER_USERNAME","i_ii_haiwan_ii_i")
...
EVALOP = list(map(int, getenv("EVALOP", "8007286147  8007286147").split()))
...
LOGGER_ID = int(getenv("LOGGER_ID", -1002422192977))

# Get this value from  on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", 8007286147))
...
STATS_IMG_URL = "https://telegra.ph/file/adfbc10955f95a1f449f0.jpg"
